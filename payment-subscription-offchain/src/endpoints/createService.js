...
exports.createServiceProgram = void 0;
...
var createServiceProgram = function (lucid, config) {
    return effect_1.Effect.gen(function () {
        var validators, servicePolicyId, merchantAddress, selectedUTxOs, selectedUTxO, _a, refTokenName, userTokenName, createServiceRedeemer, currDatum, directDatum, refToken, userToken, mintingAssets, tx;
        var _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    validators = (0, index_js_1.getMultiValidator)(lucid, constants_js_1.serviceScript);
                    servicePolicyId = (0, lucid_1.mintingPolicyToId)(validators.mintValidator);
                    return [5 /*yield**/, __values(effect_1.Effect.promise(function () { return lucid.wallet().address(); }))];
                case 1:
                    merchantAddress = _e.sent();
                ...
                case 2:
                    ...
                    directDatum = lucid_1.Data.to(currDatum, contract_types_js_1.ServiceDatum);
                    refToken = (0, lucid_1.toUnit)(servicePolicyId, refTokenName);
                    userToken = (0, lucid_1.toUnit)(servicePolicyId, userTokenName);
                    mintingAssets = (_b = {},
                        _b[refToken] = 1n,
                        _b[userToken] = 1n,
                        _b);
                    return [5 /*yield**/, __values(lucid
                            ...
                            .pay.ToAddress(merchantAddress, (_c = {}, _c[userToken] = 1n, _c))
...
exports.createServiceProgram = createServiceProgram;
