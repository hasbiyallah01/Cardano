...
exports.subscriberWithdrawProgram = void 0;
...
var subscriberWithdrawProgram = function (lucid, config) {
    return effect_1.Effect.gen(function () {
        var subscriberAddress, validators, paymentAddress, paymentUTxOs, paymentUTxO, paymentNft, subscriberNft, subscriberUTxO, paymentValue, serviceRefNft, serviceUTxO, subscriberWithdrawRedeemer, mintingAssets, mintingRedeemer, tx;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    paymentAddress = validators.spendValAddress;
                    return [5 /*yield**/, __values(effect_1.Effect.promise(function () { return lucid.utxosAt(paymentAddress); }))];
                case 2:
                    paymentUTxOs = _c.sent();
                    paymentUTxO = (0, utils_js_1.findPaymentToWithdraw)(paymentUTxOs, config.service_nft_tn, config.subscriber_nft_tn).paymentUTxO;
                ...
                case 3:
                    ...
                    paymentValue = paymentUTxO.assets.lovelace;
                ...
                case 4:
                    serviceUTxO = _c.sent();
                    subscriberWithdrawRedeemer = {
                        kind: "selected",
                        makeRedeemer: function (inputIndices) {
                            return lucid_1.Data.to(new lucid_1.Constr(3, [0n, inputIndices[0], inputIndices[1]]));
                        },
                    ...
                    mintingAssets = (_a = {},
                        _a[paymentNft] = -1n,
                        _a);
                    mintingRedeemer = lucid_1.Data.to(new lucid_1.Constr(1, []));
...
exports.subscriberWithdrawProgram = subscriberWithdrawProgram;
