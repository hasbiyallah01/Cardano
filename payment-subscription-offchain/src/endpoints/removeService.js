...
exports.removeServiceProgram = void 0;
...
var removeServiceProgram = function (lucid, config) {
    return effect_1.Effect.gen(function () {
        var validators, serviceValAddress, serviceNFT, merchantNFT, serviceUTxO, serviceData, serviceDatum, merchantUTxO, updatedDatum, directDatum, removeServiceRedeemer, tx;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [5 /*yield**/, __values(effect_1.Effect.promise(function () {
                            return lucid.utxoByUnit(serviceNFT);
                        }))];
                case 1:
                    serviceUTxO = _b.sent();
                    if (!serviceUTxO) {
                    ...
                    return [5 /*yield**/, __values(effect_1.Effect.promise(function () {
                            return lucid.utxoByUnit(merchantNFT);
                        }))];
                case 2:
...
exports.removeServiceProgram = removeServiceProgram;
