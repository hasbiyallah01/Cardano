    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<BaseResponse> SendNotificationToRestaurantAsync(Restaurant restaurant)
        {
            ...
            string emailBody = $"<p>Hello {restaurant.Name},</p>\r\n" +
                                $"<p>Welcome to Seek! We’re thrilled to have you on board as part of our network.</p>\r\n" +
                                ...
                                $"<p>As a Seek partner, you'll have access to our cutting-edge platform that connects your dishes with the right customers.</p>\r\n" +
                                $"<p>At Seek, we’re all about connecting great food with the people who love it. As a valued restaurant partner, you’ll have access to a" +
                                ...
                                $"<p>We’ll be in touch soon! <a href='https://seekai.vercel.app/'>Explore what Seek is all about</a> to see what’s ahead for your restaurant.</p>\r\n" +
                                ...
                                $"<p>Best regards,<br/>Hasbiy from Seek</p>\r\n" +
                                $"<img src=\"https://drive.google.com/uc?export=view&id=1KH6x4h7J0PCGE7yDiJj4YUBDYPHPBd3B\" alt=\"Seek Logo\" style=\"display: block; margin: 0 auto;\">\r\n";
